...
| github | GitHub org and repository names the publisher trust is pinned to. | <pre>object({<br/>    org        = optional(string, "bitwise-media-group")<br/>    containers = optional(string, "flux-containers")<br/>    manifests  = optional(string, "flux-manifests")<br/>  })</pre> | `{}` | no |
