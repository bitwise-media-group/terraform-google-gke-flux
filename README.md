...
`RBAC_GROUP_ADMINS`, `SECRET_PREFIX`, `STACK_COMPONENTS`, `CLAUDE_PROVIDER`, `CLAUDE_ANTHROPIC_AUTH`,
`CLAUDE_BEDROCK_REGION`, `CLAUDE_BEDROCK_REGION_PREFIX`, `CLAUDE_VERTEX_REGION`, `CLAUDE_VERTEX_PROJECT_ID`,
`CLAUDE_MODEL_MAP` — optional surfaces use the empty-string convention.
